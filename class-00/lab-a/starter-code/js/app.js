...
function displayPics(){
  ...
  // rando is defined within the function displayPics() so it's scope is limited to that block, the console log was outside of that block
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${event.target.id} has ${allProducts[i].votes} votes in ${allProducts[i].votes} views`;
